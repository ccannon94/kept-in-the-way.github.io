...
#
# For each newly added Jekyll post passed as an argument, stamp it with "now"
# in US Eastern time:
#
...
#   * The first front-matter `date:` line is replaced with the current Eastern
#     date+time and DST-aware offset, e.g. "date: 2026-05-27 14:32:10 -0400".
#     (-0400 in summer / EDT, -0500 in winter / EST.)
#
...
NEW_DATETIME="${POST_DATETIME:-$(TZ="$EASTERN_TZ" date +'%Y-%m-%d %H:%M:%S %z')}"
